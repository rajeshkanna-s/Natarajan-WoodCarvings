...
export const products: Product[] = [
  ...
  { id: 14, name: 'Lord Venkateshwara — Compact', description: 'Medium-sized Tirupati Balaji with prabhavali arch, golden-toned sandalwood finish.', image: '/images/gallery/product-14.jpg', category: 'Deity Statues' },
  ...
  { id: 22, name: 'Goddess Durga Seated', description: 'Seated Durga with weapons and lion vahana, light sandalwood finish with prabhavali.', image: '/images/gallery/product-22.jpg', category: 'Deity Statues' },
  ...
  { id: 24, name: 'Lord Venkateshwara — Sandalwood', description: 'Compact Balaji statue in light sandalwood with detailed prabhavali arch.', image: '/images/gallery/product-24.jpg', category: 'Deity Statues' },
